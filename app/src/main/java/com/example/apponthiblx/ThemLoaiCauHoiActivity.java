...
public class ThemLoaiCauHoiActivity extends AppCompatActivity {
    ...
    private ImageView imgLoaicauhoi;

    private static final String TAG = "ThemLoaiCauHoiActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_them_loai_cau_hoi);
        ...
        imgLoaicauhoi = findViewById(R.id.imgLoaicauhoi);
        ...
        // Chuẩn bị danh sách hình ảnh từ drawable
        ...
        spinnerAnh.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Cập nhật ImageView
                imgLoaicauhoi.setImageResource(imageResourceId);
            }
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id.isEmpty() || tenLoai.isEmpty() || moTa.isEmpty()) {
                    Toast.makeText(ThemLoaiCauHoiActivity.this, "Vui lòng nhập đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (loaiCauHoiDAO.Kiemtramaloaicauhoi(id)) {
                    Toast.makeText(ThemLoaiCauHoiActivity.this, "Mã loại câu hỏi đã tồn tại", Toast.LENGTH_SHORT).show();
                    return;
                }

                LoaiCauHoi loaiCauHoi = new LoaiCauHoi(id, tenLoai, moTa, anh);
                loaiCauHoiDAO.ThemLoaiCauHoi(loaiCauHoi);

                Toast.makeText(ThemLoaiCauHoiActivity.this, "Thêm loại câu hỏi thành công", Toast.LENGTH_SHORT).show();
